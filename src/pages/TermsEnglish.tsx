function TermsEnglish() {
    return (
        <main className="w-full min-h-screen bg-gray-50">
            <div className="container mx-auto px-8 lg:px-4 min-h-screen flex flex-col mt-20 items-start">


                <h2 className="text-3xl text-gray-700 font-bold">Terms of agreement</h2>

                <p className="text-base text-gray-800 tracking-wider py-8">
                    ...
                    derivative versions. The app itself, and all the trademarks, copyright, database rights, and other
                    intellectual property rights related to it, still belong to Univerzalna sportska škola.
                    <br/><br/>
                    Univerzalna sportska škola is committed to ensuring that the app is as useful and efficient as
                    possible.
                    <br/><br/>
                    ...
                    <br/><br/>
                    The Univerzalna app stores and processes personal data that you have provided to us, to provide our
                    ...
                    <br/><br/>
                    It could make your
                    phone vulnerable to malware/viruses/malicious programs, compromise your phone’s security features
                    and it
                    could mean that the Univerzalna app won’t work properly or at all.
                    ...
                    You should be aware that there are certain things that Univerzalna sportska škola will not take
                    responsibility for. Certain functions of the app will require the app to have an active internet
                    connection. The connection can be Wi-Fi or provided by your mobile network provider, but Univerzalna
                    sportska škola cannot take responsibility for the app not working at full functionality if you don’t
                    ...
                    country) without turning off data roaming. If you are not the bill payer for the device on which
                    you’re
                    using the app, please be aware that we assume that you have received permission from the bill payer
                    for
                    using the app.
                    <br/><br/>
                    Along the same lines, Univerzalna sportska škola cannot always take responsibility for the way you
                    use
                    the app i.e. You need to make sure that your device stays charged – if it runs out of battery and
                    you
                    can’t turn it on to avail the Service, Univerzalna sportska škola cannot accept responsibility.
                    <br/><br/>
                    With respect to Univerzalna sportska škola’s responsibility for your use of the app, when you’re
                    using
                    the app, it’s important to bear in mind that although we endeavor to ensure that it is updated and
                    correct at all times, we do rely on third parties to provide information to us so that we can make
                    it
                    available to you. Univerzalna sportska škola accepts no liability for any loss, direct or indirect,
                    you
                    ...
                    <br/><br/>
                    Univerzalna sportska škola does not promise that it will always update the app so that it is
                    relevant to
                    you and/or works with the Android version that you have installed on your device. However, you
                    promise
                    ...
                    tell
                    you otherwise, upon any termination, (a) the rights and licenses granted to you in these terms will
                    end;
